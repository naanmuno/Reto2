...
- Es muy importante contar con una estrategia de automatización al momento de realizar la creación del proyecto en el IDE. Una vez se tenga la estrategia, la forma de codificar va muy ligado a lo que se puede utilizar desde las librerías de JAVA. Lo importante es poder poner en orden cada uno de los pasos a realizar para llevar a cabo el reto.